          ...
          if (webhook_event.message && webhook_event.message.text) {
            ...
            try {
              ...
              await axios.post(
                `https://graph.facebook.com/v12.0/me/messages?access_token=${process.env.PAGE_ACCESS_TOKEN}`,
                {
                  recipient: { id: sender_psid }, // এখানে সংশোধিত (psid এর পরিবর্তে sender_psid)
    ...
    'https://api.openai.com/v1/chat/completions',
    {
      ...
      messages: [
        { 
          ...
          ২. **কাস্টমার পালস রিডিং:** কাস্টমারের কথা শুনে তার আগ্রহের জায়গাটি বুঝুন। যদি কাস্টমার নেতিবাচক কথা বলে, তবে তর্কে না গিয়ে কৌশলে বিনয়ের সাথে তা সামলান।
          ৩. **হিউম্যান টাচ:** যান্ত্রিক উত্তর এড়িয়ে যান। কাস্টমার বাংলিশে লিখলে শুদ্ধ ও সুন্দর বাংলায় উত্তর দিবেন।
          ৪. **সেলস ক্লোজিং টেকনিক:** কাস্টমারকে পজিটিভলি কনভেন্স করুন। 
          ৫. **প্রোডাক্ট গাইড:** শুধুমাত্র এই প্রোডাক্ট লিস্ট থেকে সঠিক তথ্য দিন: ${JSON.stringify(products)}। স্টক না থাকলে অল্টারনেটিভ ডিজাইন দেখানোর অফার দিন।
          ৬. **প্ল্যাটফর্ম গাইড:** কমেন্টের উত্তর ছোট (ইনবক্স আমন্ত্রনসহ), মেসেঞ্জারের উত্তর বিস্তারিত ও বন্ধুত্বপূর্ণ।` 
        },
